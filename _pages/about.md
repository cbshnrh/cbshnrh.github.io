...
## Research Interests
My research lies at the intersection of **algebra, combinatorics, and signal processing**, with a special focus on sequence and matrix design for communication systems. My main interests include:
...
- Improved results on the **existence of Hadamard matrices**, refining classical asymptotic bounds (building upon R. Craigen’s work).
- Construction of the **Generalized Step-Chirp (GSC) Sequences**, generalizing chirp-like sequences with all-pass spectrums to those with band-pass spectrums,  thus achieving flexible tradeoffs between the beamforming gain and the beam sweeping time in massive MIMO communications.
